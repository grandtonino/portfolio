...
const translations = {
  'doc-title':        { en: 'Tony — Director of Photography', es: 'Tony — Director de Fotografía' },
  ...
  'hero-sub':          { en: 'Tony — director of photography and camera assistant based in Madrid. Film, advertising and still photography treated as one visual language.',
                          es: 'Tony — director de fotografía y asistente de cámara con base en Madrid. Cine, publicidad y fotografía fija tratados como un mismo lenguaje visual.' },
  ...
  'film-1-title':      { en: 'Project name', es: 'Nombre del proyecto' },
  'film-1-type':       { en: 'Short film / Commercial / Music video', es: 'Cortometraje / Publicidad / Videoclip' },
  'film-2-title':      { en: 'Project name', es: 'Nombre del proyecto' },
  'film-2-type':       { en: 'Short film / Commercial / Music video', es: 'Cortometraje / Publicidad / Videoclip' },
  'film-3-title':      { en: 'Project name', es: 'Nombre del proyecto' },
  'film-3-type':       { en: 'Short film / Commercial / Music video', es: 'Cortometraje / Publicidad / Videoclip' },
  'meta-camera':       { en: 'Camera', es: 'Cámara' },
  'meta-lens':         { en: 'Lens', es: 'Óptica' },
  'meta-format':       { en: 'Format', es: 'Formato' },
  ...
  'foto-eyebrow':      { en: 'Still camera · Hasselblad', es: 'Cámara fija · Hasselblad' },
  'foto-title':        { en: 'Photo<em>graphy</em>', es: 'Foto<em>grafía</em>' },
  'photo-caption':     { en: 'Title — Location, format', es: 'Título — Localización, formato' },
  ...
  'footer-eyebrow':    { en: 'Available for projects and Erasmus+ internships', es: 'Disponible para proyectos y prácticas Erasmus+' },
  ...
  'footer-rights':     { en: '© 2026 Tony. All rights reserved.', es: '© 2026 Tony. Todos los derechos reservados.' },
  'footer-location':   { en: 'Madrid, Spain', es: 'Madrid, España' },
};

const metaDescription = {
  en: 'Portfolio of Tony — Director of Photography, camera work and still photography.',
  es: 'Portfolio de Tony — Director de Fotografía, trabajo de cámara y fotografía fija.'
};
